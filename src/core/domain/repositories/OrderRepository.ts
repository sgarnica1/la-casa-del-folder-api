...
export interface OrderRepository {
  ...
  updateOrderStatus(orderId: string, orderStatus: "new" | "in_production" | "ready" | "shipped" | "delivered" | "cancelled" | "refunded"): Promise<void>;
  updateOrderStatusAndPaymentStatus(orderId: string, orderStatus: "new" | "in_production" | "ready" | "shipped" | "delivered" | "cancelled" | "refunded", paymentStatus: "pending" | "paid" | "failed"): Promise<void>;
  getDraftIdsFromOrder(orderId: string): Promise<string[]>;
  findPendingOrderByCartId(cartId: string): Promise<Order | null>;
}
